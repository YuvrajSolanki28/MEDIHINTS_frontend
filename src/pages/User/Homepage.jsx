...
import { Users, HeartIcon, ActivityIcon, PlusSquareIcon, DropletIcon, ShieldIcon } from 'lucide-react';
        ...
        >
          ...
          <motion.div className="md:col-span-3">
            <div className="space-y-2">
              {[
                { icon: <ActivityIcon className="w-6 h-6 text-blue-500" />, label: "Free Checkup", onClick: () => alert("Navigating to Free Checkup") },
                { icon: <HeartIcon className="w-6 h-6 text-blue-500" />, label: "Cardiogram", onClick: () => alert("Navigating to Cardiogram") },
                { icon: <PlusSquareIcon className="w-6 h-6 text-blue-500" />, label: "DNA Testing", onClick: () => alert("Navigating to DNA Testing") },
                { icon: <DropletIcon className="w-6 h-6 text-blue-500" />, label: "Blood Bank", onClick: () => navigate("/bloodbank") },
                { icon: <ShieldIcon className="w-6 h-6 text-blue-500" />, label: "Cancer Screening", onClick: () => navigate("/coming") },
              ].map((service, index) => (
                <motion.button
                  key={index}
                  whileHover={{ scale: 1.05 }}
                  ...
                  className="flex items-center gap-3 p-4 transition bg-white border rounded-lg shadow cursor-pointer hover:border-blue-500"
                >
                  {service.icon}
