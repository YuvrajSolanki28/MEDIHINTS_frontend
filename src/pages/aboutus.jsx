...
export default function AboutUs() {
    ...
    >
      ...
      <div
        ...
        data-id="element-1"
      >
        <div className="relative mb-8" data-id="element-2">
          <span
            className="text-6xl text-white opacity-20 absolute -top-8 left-1/2 -translate-x-1/2"
            data-id="element-3"
          >
            "
          </span>
          <p
            className="text-white text-lg md:text-2xl leading-relaxed px-4 md:px-12"
            data-id="element-4"
          >
        ...
        <div className="mb-12" data-id="element-5">
          <h3 className="text-white text-xl font-medium" data-id="element-6">
